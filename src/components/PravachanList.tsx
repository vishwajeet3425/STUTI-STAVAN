...
export default function PravachanList({ pravachans }: PravachanListProps) {
  ...
  const categories = [
    { id: 'All', label: 'सभी प्रवचन' },
    { id: 'leela', label: 'लीला चिंतन' },
    { id: 'sutra', label: 'सूत्रपाठ निरूपण' },
    { id: 'achara', label: 'आचार विवेचन' }
  ];
    ...
    <div id="pravachan-root" className="bg-white rounded-2xl shadow-md border border-saffron-100 overflow-hidden min-h-[500px]">
      ...
      <div className="bg-saffron-50 p-6 border-b border-saffron-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-saffron-700 font-devanagari flex items-center gap-2">
            ...
            पावन प्रवचन (Discourses)
          </h2>
          <p className="text-sm text-gray-600 mt-1 font-sans">
            श्रद्धेय आचार्यों और शास्त्री जी महाराज द्वारा ग्रंथों के निरूपण की अमृतवाणी।
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="प्रवचन या वक्ता खोजें..."
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 min-h-[400px]">
        ...
        <div className="border-r border-saffron-100 p-4 bg-saffron-50/30 overflow-y-auto max-h-[450px] custom-scrollbar">
          <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">प्रवचनों की सूची</h3>
          <div className="space-y-3">
            {filteredPravachans.length === 0 ? (
              <p className="text-xs text-gray-400 py-6 text-center">कोई प्रवचन नहीं मिला।</p>
            ) : (
        ...
        <div className="col-span-1 md:col-span-2 p-6 flex flex-col bg-white">
          {selectedPravachan ? (
            <div className="flex-1 flex flex-col justify-between">
              <div>
                <div className="flex items-start justify-between border-b border-gray-100 pb-4 mb-5 gap-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1 font-sans">
                      प्रवचनकार: <span className="font-semibold text-gray-700">{selectedPravachan.speaker}</span>
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      ...
                      {isPlaying ? 'रोकें (Pause)' : 'प्रवचन सुनें'}
                    </button>
                ...
                <div className="p-5 border border-saffron-100 rounded-2xl bg-saffron-50/20 shadow-sm flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm font-devanagari">ज्ञान चिंतन विवरण:</h4>
                    <p className="text-xs md:text-sm text-gray-600 mt-1 font-sans leading-relaxed">
                      इस प्रवचन सत्र में महानुभाव आचार्यों ने सर्वज्ञ श्री चक्रधर स्वामी महाराज की लीलाओं के मर्म और धर्मग्रंथों की व्याख्या की है। साधकों को धर्म में लीन रहने तथा वैराग्य भाव पुष्ट करने के व्यावहारिक तरीके बताये गए हैं।
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-8 p-3 bg-saffron-50/50 rounded-xl border border-saffron-100 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-600 font-sans">
                      {isPlaying ? `अभी चल रहा है: ${selectedPravachan.title}` : 'ऑडियो श्रवण के लिए तैयार।'}
                    </span>
                  </div>
                  {isPlaying && (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
              ...
              <h3 className="text-lg font-bold text-gray-800 font-devanagari">प्रवचन श्रवण करें</h3>
