                ...
                <div className="p-5 border border-saffron-100 rounded-2xl bg-saffron-50/20 shadow-sm flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-gray-600 mt-1 font-sans leading-relaxed">
                      {lang === 'mr' 
                        ? 'या प्रवचन सत्रात महानुभाव आचार्यांनी सर्वज्ञ श्री चक्रधर स्वामी महाराजांच्या लीळांचे मर्म आणि धर्मग्रंथांचे निरूपण केले आहे. साधकांना धर्मात लीन राहण्याचे व वैराग्य भाव दृढ करण्याचे व्यावहारिक मार्ग सांगितले आहेत.' 
                        : lang === 'hi' 
